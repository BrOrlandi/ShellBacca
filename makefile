...
objects = main.o parse.o shell.o historico.o LinuxUtils.o signal_handler.o linha_comando.o stringcmd.o internal_commands.o processes_handler.o  #List of objects that will be linked
